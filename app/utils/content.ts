    ...
    data: [
      {
        ...
        status: "Part-time",
        description: [
          "Managed and customized SAP Business One ERP improving internal workflows and business data handling",
          "Developed advanced SQL queries in SAP HANA to support reporting and operational automation",
          "Created custom SAP Add-Ons aligned with specific business requirements",
          "Designed and developed an Angular-based web platform to centralize Add-Ons by user role and company",
          "Implemented dynamic form automation to optimize internal processes and reduce manual input",
          "Integrated web applications with backend services using Python and FastAPI",
        ],
        technologies: [
          "SAP Business One",
          "SAP HANA",
      ...
      },
      {
        ...
        description: [
          "Contributed to development and improvement of the 'Jornada Universitaria del Conocimiento' platform",
          "Developed frontend features using Angular to improve usability and navigation",
          "Collaborated on backend improvements using Django focusing on code optimization and maintainability",
          "Implemented new statistics modules to support data visualization and reporting",
          "Added access restrictions and validation rules to improve security and data integrity",
        ],
        technologies: ["Angular", "Django", "Python", "Frontend", "Backend"],
      },
    ],
