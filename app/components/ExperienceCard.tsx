...
export function ExperienceCard({ experience }: ExperienceCardProps) {
  return (
    <div className="relative pl-12 lg:pl-16">
      {/* Timeline dot */}
      <div className="absolute left-0 lg:left-[5px] top-2 w-4 h-4 rounded-full bg-blue-600 border-3 border-hero"></div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Left column */}
        <div className="space-y-3">
          <div>
            <h3 className="text-xl lg:text-lg font-bold text-blue-600">
              {experience.position}
            </h3>
